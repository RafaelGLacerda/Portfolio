...
export default function Portfolio() {
  ...
  const projects = [
    ...
    {
      title: "CineVault",
      description: "Biblioteca Virtual de Filmes.",
      tech: ["Next.js", "TypeScript", "Tailwind"],
      image: "/cine.png",
      demo: "https://cinevaultlist.vercel.app/",
      featured: true,
    },
    {
      title: "dietmealorganizer",
      description: "Criador de Dietas Personalizadas.",
      tech: ["Next.js", "TypeScript", "Tailwind"],
      image: "/diet.png",
      demo: "https://dietmealorganizer.vercel.app/",
      featured: true,
    },
    {
      title: "VooEmbarcar",
    ...
    {
      title: "EasyBusiness",
      description: "Marketplace que Conecta Empresas e Clientes.",
      tech: ["HTML5", "CSS3", "JS"],
      image: "/easy.png",
